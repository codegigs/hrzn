      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#" onclick="location.href='<%=request.getContextPath()%>/request'"><i class="fa fa-link"></i>Type</a></li>
            <li><a href="#" onclick="location.href='<%=request.getContextPath()%>/company'"><i class="fa fa-link"></i>Request</a></li>
          </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
...
<spring:url value="/resources/zmycustomjs/mytype.js" var="mytypejs" />
<script src="${mytypejs}"></script>
